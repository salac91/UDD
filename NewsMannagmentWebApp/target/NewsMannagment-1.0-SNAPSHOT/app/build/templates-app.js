angular.module('templates-app', ['about/about.tpl.html', 'account/login.tpl.html', 'account/register.tpl.html', 'home/home.tpl.html', 'mainPage/mainPage.tpl.html', 'mainPage/publishPage.tpl.html', 'mainPage/search.tpl.html', 'mainPage/textPage.tpl.html']);
...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    ...
    "      Register\n" +
    "    </a>\n" +
    "    <a ui-sref=\"mainPage\" class=\"btn btn-large btn-success\">\n" +
    "      <i class=\"fa fa-download\"></i>\n" +
    "      All texts\n" +
    "    </a>\n" +
    "    <a ui-sref=\"search\" class=\"btn btn-large btn-success\">\n" +
    "      <i class=\"fa fa-book\"></i>\n" +
    "      Pretraga\n" +
    "    </a>\n" +
    "    <a ui-sref=\"publishPage\" class=\"btn btn-large btn-success\">\n" +
    "      <i class=\"fa fa-book\"></i>\n" +
    "      Unpublished texts\n" +
    "    </a>\n" +
    "  </div>\n" +
...
angular.module("mainPage/mainPage.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("mainPage/mainPage.tpl.html",
    "<div class=\"row\">\n" +
    " 	 <h1 class=\"page-header\">\n" +
    "      	All public texts\n" +
    " 	 </h1>\n" +
    " 	 <div class=\"table-responsive\">\n" +
    "              <table class=\"table table-striped\" style=\"border: 1px groove; border-color:#F7F7F7\"\">\n" +
    "                   <thead>\n" +
    ...
    "                         <td>{{doc.title}}</td>\n" +
    "                         <td>{{doc.apstract}}</td>\n" +
    "                         <td><a ui-sref=\"textPage\" ng-click=\"readText(doc)\"><u>Read</u></a></td>\n" +
    "                         <td><button type=\"submit\" class=\"btn btn-primary\" ng-click=\"removeDocument(doc.uid)\">Remove</button></td>\n" +
    "                     </tr>                \n" +
    "                   </tbody>\n" +
    "             </table>                  \n" +
    "  	 </div>\n" +
    ...
    "   			<input type=\"file\" name=\"file\" ng-model=\"document.fileInput\" id=\"file\" onchange=\"angular.element(this).scope().setFile(this)\"/>\n" +
...
angular.module("mainPage/publishPage.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("mainPage/publishPage.tpl.html",
    "<div class=\"row\">\n" +
    " 	 <h1 class=\"page-header\">\n" +
    "      	Publishing page\n" +
    " 	 </h1>\n" +
    ...
    "                   </thead>\n" +
    "                   <tbody>\n" +
    "                     <tr data-ng-repeat=\"doc in unpublishedDocs\">\n" +
    "                     	 <td>{{doc.uid}}</td>\n" +
    "                         <td>{{doc.title}}</td>\n" +
    "                         <td>{{doc.apstract}}</td>\n" +
    "                         <td><button type=\"submit\" class=\"btn btn-primary\" ng-click=\"publishDocument(doc.uid)\">Publish</button></td>\n" +
    "                     </tr>                \n" +
    "                   </tbody>\n" +
    "             </table>                  \n" +
    "  	 </div>\n" +
    "  	 \n" +
    "  	 <div>\n" +
    "  	 	<form ng-submit=\"updateDocument()\" class=\"form-horizontal\">\n" +
    "  	 		<div ng-if=\"missingFields.title\"> <label>Title:</label> <input class=\"form-control\" type=\"text\" ng-model=\"updatedDoc.title\"/> </div>\n" +
    "  	 		<div ng-if=\"missingFields.apstract\"> <label>Apstract:</label> <input class=\"form-control\" type=\"text\" ng-model=\"updatedDoc.apstract\"/> </div>\n" +
    "  	 		<div ng-if=\"missingFields.category\"> <label>Category:</label> <input class=\"form-control\" type=\"text\" ng-model=\"updatedDoc.category\"/> </div>\n" +
    "  	 		<div ng-if=\"missingFields.keywords\"> <label>Keywords:</label> <input class=\"form-control\" type=\"text\" ng-model=\"updatedDoc.keyWords\"/> </div>\n" +
    "  	 		<div ng-if=\"missingFields.tags\"> <label>Tags:</label><input class=\"form-control\" type=\"text\" ng-model=\"updatedDoc.tags\"/> </div>\n" +
...
angular.module("mainPage/search.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("mainPage/search.tpl.html",
    "<div class=\"row\">\n" +
    "  <h1 class=\"page-header\">\n" +
    "      Pretraga\n" +
    "  </h1>\n" +
    "  <div class=\"row\">\n" +
    "  <form ng-submit=\"searchAdvanced()\">\n" +
    "  	\n" +
    "      <div class=\"form-group\">\n" +
    ...
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.titleSearchType\">\n" +
    ...
    "	      </div>\n" +
    "	      <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.titleSearchCondition\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Condition\">\n" +
    ...
    "          <div class=\"col-sm-3\">\n" +
    "          	<input class=\"form-control\" type=\"text\" ng-model = \"model.author\"/>\n" +
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.authorSearchType\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Type\">\n" +
    "	          		<option value=\"regular\">Regular</option>\n" +
    "	          		<option value=\"fuzzy\">Fuzzy</option>\n" +
    "	          		<option value=\"phrase\">Phrase</option>\n" +
    ...
    "	      </div>\n" +
    "	      <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.authorSearchCondition\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Condition\">\n" +
    "	          		<option value=\"must\">Must</option>\n" +
    "	          		<option value=\"mustNot\">Must not</option>\n" +
    "	          		<option value=\"should\">Should</option>\n" +
    ...
    "          <div class=\"col-sm-3\">\n" +
    "          	<input class=\"form-control\" type=\"text\" ng-model = \"model.publishingDate\"/>\n" +
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.dateSearchType\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Type\">\n" +
    "	          		<option value=\"regular\">Regular</option>\n" +
    "	          		<option value=\"fuzzy\">Fuzzy</option>\n" +
    "	          		<option value=\"phrase\">Phrase</option>\n" +
    ...
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.dateSearchCondition\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Condition\">\n" +
    "	          		<option value=\"must\">Must</option>\n" +
    "	          		<option value=\"mustNot\">Must not</option>\n" +
    "	          		<option value=\"should\">Should</option>\n" +
    ...
    "      \n" +
    "      <div class=\"form-group\">\n" +
    "          <label class=\"control-label col-sm-1\">Apstract</label>\n" +
    "          <div class=\"col-sm-3\">\n" +
    "          	<input class=\"form-control\" type=\"text\" ng-model = \"model.apstract\"/>\n" +
    "          </div>\n" +
    "          <div class=\"col-sm-4\">	\n" +
    "	          <select class=\"form-control\" ng-model=\"model.apstractSearchType\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Type\">\n" +
    "	          		<option value=\"regular\">Regular</option>\n" +
    "	          		<option value=\"fuzzy\">Fuzzy</option>\n" +
    "	          		<option value=\"phrase\">Phrase</option>\n" +
    ...
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.apstractSearchCondition\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Condition\">\n" +
    "	          		<option value=\"must\">Must</option>\n" +
    "	          		<option value=\"mustNot\">Must not</option>\n" +
    "	          		<option value=\"should\">Should</option>\n" +
    ...
    "	      </div>\n" +
    "	      <div class=\"col-sm-4\">    \n" +
    "	          <select class=\"form-control\" ng-model=\"model.textSearchCondition\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Condition\">\n" +
    "	          		<option value=\"must\">Must</option>\n" +
    "	          		<option value=\"mustNot\">Must not</option>\n" +
    "	          		<option value=\"should\">Should</option>\n" +
    ...
    "          <div class=\"col-sm-3\">\n" +
    "          	<input class=\"form-control\" type=\"text\" ng-model = \"model.category\"/>\n" +
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.categorySearchType\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Type\">\n" +
    "	          		<option value=\"regular\">Regular</option>\n" +
    "	          		<option value=\"fuzzy\">Fuzzy</option>\n" +
    "	          		<option value=\"phrase\">Phrase</option>\n" +
    ...
    "          </div>\n" +
    "          <div class=\"col-sm-4\">\n" +
    "	          <select class=\"form-control\" ng-model=\"model.categorySearchCondition\">\n" +
    "	          	<optgroup style=\"font-size:18px;\" label=\"Search Condition\">\n" +
    "	          		<option value=\"must\">Must</option>\n" +
    "	          		<option value=\"mustNot\">Must not</option>\n" +
    "	          		<option value=\"should\">Should</option>\n" +
...
angular.module("mainPage/textPage.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("mainPage/textPage.tpl.html",
    "<div class=\"row\">\n" +
    " 	 <h1 class=\"page-header\">\n" +
    "      	Read text\n" +
    " 	 </h1>\n" +
